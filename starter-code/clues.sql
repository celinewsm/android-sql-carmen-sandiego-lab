...
SELECT * FROM country;
SELECT code , name , region , population FROM country WHERE region='Southern Europe' ORDER BY population ASC;
...
SELECT code , name , region FROM country WHERE region='South America' AND name LIKE 'S%';

SELECT city.name , city.countrycode FROM city INNER JOIN country ON (city.countrycode = country.code) WHERE city.name LIKE 'Ser%' AND country.region='South America';
-- name     | countrycode
-- -------------+-------------
-- Serra       | BRA
-- Sert�ozinho | BRA
...
-- She's in __________Santa Monica___________!
